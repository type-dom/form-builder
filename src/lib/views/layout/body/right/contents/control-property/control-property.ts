import { Division, StyleDisplay, TextNode, TypeDiv } from '@type-dom/framework';
...
export class ControlProperty extends TypeDiv {
  ...
  get observerList(): PropertyItem[] {
    return this.childNodes.filter(
      (item) => item instanceof PropertyItem
    ) as PropertyItem[];
  }
  ...
  reset(): void {
    ...
    const className = this.formBuilder.selectedControl?.className;
